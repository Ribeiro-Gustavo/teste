    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-gray-400 text-sm">Itens no Carrinho</p>
            ...
            <div class="bg-gray-800 rounded-xl p-6 border border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-gray-400 text-sm">Avaliação</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gray-800 rounded-xl p-8 border border-gray-700">
                ...
                <div class="space-y-4">
                    <a href="{{ route('cardapios.index') }}" class="flex items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors duration-200 group">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-gray-400 text-sm">Visualizar e editar produtos</p>
                        </div>
                        <i class="fas fa-chevron-right text-gray-400 ml-auto"></i>
                    </a>

                    <a href="{{ route('cardapios.create') }}" class="flex items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors duration-200 group">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-gray-400 text-sm">Criar novo item no cardápio</p>
                        </div>
                        <i class="fas fa-chevron-right text-gray-400 ml-auto"></i>
                    </a>

                    <a href="{{ route('sobre') }}" class="flex items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors duration-200 group">
                        <div class="bg-blue-600 p-3 rounded-lg group-hover:bg-blue-700 transition-colors duration-200">
                            <i class="fas fa-info-circle text-white"></i>
                        </div>
                        <div class="ml-4">
                            <h3 class="text-white font-semibold">Sobre a Hamburgueria</h3>
                            <p class="text-gray-400 text-sm">Nossa história e valores</p>
                        </div>
                        <i class="fas fa-chevron-right text-gray-400 ml-auto"></i>
                    </a>
                </div>
